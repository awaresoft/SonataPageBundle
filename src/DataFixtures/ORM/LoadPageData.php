...
CONTENT
        ...
        $homepage->addBlocks(
            $bottom = $blockInteractor->createNewContainer([
                'enabled' => true,
                'page' => $homepage,
                'code' => 'content_bottom',
            ])
        ...
        $homepage->addBlocks(
            $extra = $blockInteractor->createNewContainer([
                'enabled' => true,
                'page' => $homepage,
                'code' => 'extra',
            ])
    ...
    public function createGlobalPage(SiteInterface $site)
    {
        ...
        $global->addBlocks(
            $breadcrumb = $blockInteractor->createNewContainer([
                'enabled' => true,
                'page' => $global,
        ...
        $global->addBlocks(
            $bottomFooter = $blockInteractor->createNewContainer([
                'enabled' => true,
                'page' => $global,
